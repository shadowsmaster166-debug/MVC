...
class BarangModel extends Database{
    ...
    public function insert($data){
        ...
        'expired_date' => $data['kadaluarsa']
        ];
        return $this->insertData($table); //Query Builder
    }

    public function getById($id){
        // $query = "SELECT * FROM barang WHERE barang_id = ?";
        // return $this->qry($query, [$id])->fetch();
        return $this->get(['barang_id' => $id])->fetch(); //Query Builder
    }
    ...
    public function update($data){
        ...
        return $this->updateData($table, $key); //Query Builder
    }

    public function delete($id){
        // $query = "DELETE FROM barang WHERE barang_id = ?";
        // return $this->qry($query, [$id]);
        return $this->deleteData(['barang_id' => $id]); //Query Builder
    }
}